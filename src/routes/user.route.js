...
import { dashboardData, getAllCustomerList, getSingleCustomerDetail, handleCreateUser, handleLoginUser, updateAdminPassword, updateUserDetails } from '../controllers/user.controller.js';
